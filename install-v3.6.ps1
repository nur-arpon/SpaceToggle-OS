# ==============================================================================
# SpaceToggle OS (Universal Setup Script - V3.6.1 Hotfix Engine)
# ==============================================================================
...
; Centralized Global Path Matrix for "Chaos Apps" (V3.6.1 Variable Fix)
GetAppPath(exeTarget) {
    ...
    for path in paths {
        if FileExist(path) {
            if (exeTarget = "Discord.exe" && InStr(path, "Update.exe"))
