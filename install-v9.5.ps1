# ==============================================================================
# SpaceToggle OS (Universal Setup Script - V9.5 Core Matrix Core)
# ==============================================================================
...
$ahkScript = "$installDir\SpaceToggleV95.ahk"
...
$scriptLines | Set-Content -Path $ahkScript -Encoding UTF8 -Force

Write-Host "⚙️ Registering Window Manager to Startup Sequence..." -ForegroundColor Yellow
$WshShell = New-Object -ComObject WScript.Shell
$StartupPath = "$env:APPDATA\Microsoft\Windows\Start Menu\Programs\Startup\SpaceToggleV95.lnk"
...
Write-Host "⚡ Firing up SpaceToggle OS V9.5 Core Matrix..." -ForegroundColor Green
...
if (Test-Path ".git") {
    ...
    git add .
    git commit -m "Auto-Sync Engine Build V9.5.0: $CurrentTimestamp"
